...
\NEW{Item}{\iCrystal}{
  \s\MYname	{Crystal}
  \s\MYnumber	{50003}
  \s\MYtext	{A crystal with a pulsing purple glow.}
  }
...
\NEW{Item}{\iHypercube}{
  \s\MYname	{Hypercube}
  \s\MYnumber	{50005}
  \s\MYtext	{A cubelike object... but something is off about it. It makes you queasy to look at it.}
  }
...
\NEW{Item}{\iFlashlight}{
  \s\MYname	{Flashlight}
  \s\MYnumber	{50009}
  \s\MYtext	{A device that emits light at the touch of a button.}
  }
...
\NEW{Item}{\iRayGun}{
  \s\MYname	{Ray Gun}
  \s\MYnumber	{20006}
  \s\MYtext	{A ray gun. Weapon. +1 to CR and makes ranged attacks possible.}
  \bulky	{1}
  }
...
\NEW{Item}{\iAethericMetal}{
  ...
  \s\MYnumber	{10018}
  \s\MYtext	{A hunk of aetheric metal.}
  }
