...
\NEW{Item}{\iKnife}{
  ...
  \s\MYnumber	{20002}
  \s\MYtext	{A sharp butcher knife. Weapon. +1 to CR.}
  \bulky	{1}
  }
...
\NEW{Item}{\iMetalShard}{
  ...
  \s\MYnumber	{10005}
  \s\MYtext	{A sharp shard of metal.}
  }
...
\NEW{Item}{\iBrokenTrash}{
  ...
  \s\MYnumber	{10012}
  \s\MYtext	{Broken trash with lots of sharp edges.}
  }
