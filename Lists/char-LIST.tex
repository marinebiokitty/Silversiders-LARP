...
\NEW{PC}{\cBeauty}{
  ...
  \s\MYfile	{Beauty.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{A gorgeous Bulb wearing a shiny, skin-tight suit adorned with sparkling pebbles}
  \s\MYsex	{\female}
  \s\MYplayer	{Test Player}
...
\NEW{PC}{\cOutcast}{
  ...
  \s\MYnumber	{00000}
  \s\MYdesc	{A heavy-set, weather-worn Bulb in a drab, skin-tight suit}
  \s\MYsex	{\female}
  \s\MYplayer	{Test Player}
...
\NEW{PC}{\cHonor}{
  ...
  \s\MYfile	{Honor.tex}
  \s\MYnumber	{00000}
  \s\MYdesc	{A dignified Bulb wearing a softly glowing skin-tight suit}
  \s\MYsex	{\male}
  \s\MYplayer	{Test Player}
