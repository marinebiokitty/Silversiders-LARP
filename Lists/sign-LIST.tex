...
\NEW{Sign}{\sArchetypeObjects}{
	\s\MYname	{Archetype Objects}
	\s\MYtext	{This is an Out of Game Packet for retrieval of relevant things}
	\s\MYitems	{\iTruth{}\iWar{}\iDeath{}\iFamine{}\iPestilence{}\iLove{}\iBeauty{}\iHonor{}\iIngenuity{}}
}

\NEW{Sign}{\sHPacket}{
	\s\MYname	{H Packet}
	\s\MYtext	{This is an Out of Game Packet for retrieval of relevant things}
	\s\MYabils	{\multi{5}{\aPowerfulHypnosis{}}}
}

\NEW{Sign}{\sAPacket}{
	\s\MYname	{A Packet}
	\s\MYtext	{This is an Out of Game Packet for retrieval of relevant things}
	\s\MYitems	{\multi{10}{\iLockpick{}}}
}

\NEW{Sign}{\sXPacket}{
	\s\MYname	{X Packet}
	\s\MYtext	{This is an Out of Game Packet for retrieval of relevant things}
	\s\MYitems	{\multi{5}{\iPoisonedVeal{}}}
}
